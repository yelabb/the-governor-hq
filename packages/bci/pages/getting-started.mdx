...
**Other domains:** See [constitution-wearables](https://npmjs.com/package/@yelabb/constitution-wearables), [constitution-therapy](https://npmjs.com/package/@yelabb/constitution-therapy), or [constitution-core](https://npmjs.com/package/@yelabb/constitution-core)
...
```json
{
  "mcpServers": {
    "governor-hq-bci": {
      "command": "node",
      "args": ["./node_modules/@yelabb/constitution-bci/dist/mcp-server.js"]
    }
  }
}
```
...
// .vscode/settings.json
{
  "github.copilot.chat.codeGeneration.instructions": [
    {
      "file": "docs/governor-hq/packages/bci/README.md"
    }
  ]
}
```
...
Reference: ./docs/governor-hq/packages/bci/
```
...
{
  "scripts": {
    "ai:context": "node ./node_modules/@yelabb/constitution-bci/dist/mcp-server.js"
  }
}
```
...
- 💬 [Issues & Questions](https://github.com/yelabb/the-governor-hq/issues)
