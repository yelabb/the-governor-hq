...
export declare const BCI_CONSTRAINTS: BCIConstraints;
export declare const BCI_PRINCIPLES: BCIProductPrinciples;
/**
 * Validate text for BCI-specific safety constraints
 * @param text - The text to validate
 * @returns Validation result with violations if any
 */
export declare function validateBCILanguage(text: string): ValidationResult;
/**
 * Check if feature is within allowed BCI scope
 * @param feature - Feature description
 * @returns Validation result
 */
export declare function validateBCIScope(feature: string): ValidationResult;
