...
Primary validation uses regex patterns and keyword matching:
...
### 2. LLM Judge (Optional, for edge cases)
...
```typescript
import { createValidator, type ValidationRule } from '@yelabb/constitution-core';
