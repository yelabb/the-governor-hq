...
const DOMAIN_SAFE_MESSAGES: Record<Domain, string> = {
 ...
 */
export function createViolationExplanation(patterns: PatternCheckResult): string {
 ...
 */
export function getDisclaimer(domain: Domain): string {
  const disclaimers: Record<Domain, string> = {
