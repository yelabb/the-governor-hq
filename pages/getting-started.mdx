...
- **`@the-governor-hq/constitution-wearables`** - For wearables/smartwatch data projects
- **`@the-governor-hq/constitution-bci`** - For brain-computer interface projects  
- **`@the-governor-hq/constitution-therapy`** - For therapy/mental health data projects
- **`@the-governor-hq/constitution-core`** - Core utilities for custom implementations

> **Migrating from old package?** If you previously used `@the-governor-hq/constitution`, uninstall it and choose the domain-specific package above.
