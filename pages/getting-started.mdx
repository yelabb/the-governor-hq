...
**The Governor HQ** is now a **monorepo** with domain-specific packages. Choose the package that matches your project:

- **`@yelabb/constitution-wearables`** - For wearables/smartwatch data projects
- **`@yelabb/constitution-bci`** - For brain-computer interface projects  
- **`@yelabb/constitution-therapy`** - For therapy/mental health data projects
- **`@yelabb/constitution-core`** - Core utilities for custom implementations

> **Migrating from old package?** If you previously used `@yelabb/constitution`, uninstall it and choose the domain-specific package above.

---

## ⚡ Instant Setup (Recommended)

**Install the constitution for your domain:**

```bash
# For Wearables/Smartwatch Projects
npm install --save-dev @yelabb/constitution-wearables

# For Brain-Computer Interface (BCI) Projects
npm install --save-dev @yelabb/constitution-bci

# For Therapy/Mental Health Data Projects
npm install --save-dev @yelabb/constitution-therapy

# Core utilities only (for custom implementations)
...
Your AI coding assistant is now safety-aware for your specific health data domain.
...
```json
{
  "mcpServers": {
    "governor-hq-wearables": {
      "command": "node",
      "args": ["./node_modules/@yelabb/constitution-wearables/mcp-server.js"]
    }
  }
}
```

**Note:** Replace `constitution-wearables` with your installed package (`constitution-bci`, `constitution-therapy`, etc.)
...
cd your-project/
git submodule add https://github.com/yelabb/the-governor-hq.git docs/governor-hq
git submodule update --init --recursive

# Option B: Clone separately
cd ~/projects/
git clone https://github.com/yelabb/the-governor-hq.git governor-hq-docs
```
...
// .vscode/settings.json
{
  "github.copilot.chat.codeGeneration.instructions": [
    {
      "file": "docs/governor-hq/README.md"
    }
  ]
}
```
...
constitutional framework in /docs/governor-hq/. Check /constraints/hard-rules.mdx 
...
constitutional framework in /docs/governor-hq/.
...
- Check /docs/governor-hq/constraints/hard-rules.mdx
- Validate text against /docs/governor-hq/constraints/language-rules.mdx
- Confirm scope in /docs/governor-hq/what-we-dont-do.mdx
...
This project follows the [Governor HQ Constitutional Framework](./docs/governor-hq/) 
...
**For developers:** Review `/docs/governor-hq/README.md` before building health-related features.
```
...
- [ ] Validated against /what-we-dont-do.mdx

**For reviewers:** Any health-related content must be validated against 
[constitutional framework](./docs/governor-hq/).
```
